...
def main():
    ...
    # this will get the variables set via .env specified in docker-compose.yml env_file section
    ...
    df = pd.read_csv("data/northwind_UTF8.csv", skiprows=1, names=col_names)
